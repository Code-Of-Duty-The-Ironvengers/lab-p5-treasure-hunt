class Game {
  ...
  isColliding() {
    const bottomOfPlayer = this.player.column + this.player.height;
    const topOfTreasure = this.treasure.column;
    const isBottomOfPlayer = bottomOfPlayer >= topOfTreasure;

    const topOfPlayer = this.player.column;
    const bottomOfTreasure = this.treasure.height + this.treasure.column;
